                                    ...
                                    <div class="container-fluid">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-3">
                                                ...
                                                <img src="imagenesDiseño/foto1.png" id="lamp" right="10" width="40" height="32"><br>
                                                <h5>Camisas manga larga</h5>
                                                <button  onclick="draw('no-repeat')">select</button>
                                                <br>
                                                <br>
                                                <img src="imagenesDiseño/foto2.png" id="lam" right="10" width="40" height="32"><br>
                                                <h5>Camisetas</h5>
                                                <button  onclick="draw2('no-repeat')">select</button>
                                                <br>
                                                <br>
                                                <img src="imagenesDiseño/foto3.png"   id="lampa" right="10" width="40" height="32"><br>
                                                <h5>Sudaderas</h5>
